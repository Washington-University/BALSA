...
<html>
	...
	<body>
		<div role="main">
			<h3>Submitting Data to BALSA</h3>
			...
			<div class="well" style="overflow: hidden;font-size:15px;line-height:1.6em">
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active" style="text-align: center;width:11.1111%"><a href="#gettingStarted" aria-controls="home" role="tab" data-toggle="tab">Get Started</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#submitting" aria-controls="home" role="tab" data-toggle="tab">Workflow</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#creatingScenes" aria-controls="home" role="tab" data-toggle="tab">Create Scenes</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#uploading" aria-controls="home" role="tab" data-toggle="tab">Upload Data</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#metadata" aria-controls="home" role="tab" data-toggle="tab">Metadata</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#curation" aria-controls="home" role="tab" data-toggle="tab">Curation</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#urls" aria-controls="home" role="tab" data-toggle="tab">Add Links</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#revising" aria-controls="home" role="tab" data-toggle="tab">Revise Scenes</a></li>
					<li role="presentation" style="text-align: center;width:11.1111%"><a href="#directories" aria-controls="home" role="tab" data-toggle="tab">Directory Tips</a></li>
				</ul>
				<div class="tab-content" style="">
					<div role="tabpanel" class="tab-pane whitetab active" id="gettingStarted">
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="submitting">
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="creatingScenes">
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="uploading">
						<p>
						...
						<g:img file="upload.png" style="display:block;margin:auto;border:1px solid gray"/><br>
						<g:img file="create.png" style="display:block;margin:auto;border:1px solid gray"/><br>
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="metadata">
						<g:img file="manage.png" class="pull-right" style="padding-left:15px"/>
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="curation">
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="urls">
					...
					<div role="tabpanel" class="tab-pane whitetab" id="revising">
						<p>
					...
					<div role="tabpanel" class="tab-pane whitetab" id="directories">
