...
<button type="button" class="btn btn-default canedit" onclick="bootbox.prompt({title: 'Required Action', inputType: 'checkbox', 
...
<g:else>
<button type="button" class="btn btn-default canedit" onclick="bootbox.confirm({size: 'small', message: 'Submit this study for curation?', 
	callback: function(result) {
		if (result) {
			$(location).attr('href','<g:createLink action="submitForCuration" id="${versionInstance.dataset.id}" params="[version: versionInstance.id]"/>');
		} 
...
<g:else>
<button type="button" class="btn btn-default canedit" disabled="disabled" data-toggle="tooltip" data-placement="bottom" title="Dataset has unaddressed issues.">Submit for Curation</button>
</g:else>
</g:if>

<sec:ifNotGranted roles="ROLE_CURATOR">
<g:if test="${versionInstance.isSubmitted()}">
<button type="button" class="btn btn-default canedit" onclick="bootbox.confirm({size: 'small', message: 'Withdraw this study from curation?', 
...
<button type="button" class="btn btn-default canedit" onclick="bootbox.confirm({size: 'small', message: 'Withdraw this study from approval?', 
...
<button type="button" class="btn btn-default canedit" onclick="bootbox.confirm({size: 'small', message: 'Make this study non-public?', 
...
<button type="button" class="btn btn-default canedit" onclick="bootbox.confirm({size: 'small', message: 'Approve this study?', 
...
<g:else>
<button type="button" class="btn btn-default canedit" disabled="disabled" data-toggle="tooltip" data-placement="bottom" title="Dataset has unresolved issues.">Approve</button>
</g:else>
<button type="button" class="btn btn-default canedit" onclick="bootbox.confirm({size: 'small', message: 'Return this study to its owners for revision?', 
